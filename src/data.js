...
export const listProyek = [
  {
    id: 1,
    gambar: Proyek1,
    nama: "Decision Support System for Social Assistance",
    desk: "A decision support system for social aid distribution using the TOPSIS method at the Walinagari Talaok Office, Bayang District, Pesisir Selatan Regency.",
  ...
  },
  {
    id: 2,
    gambar: Proyek2,
    nama: "Rainfall Prediction System",
    desk: "A web-based rainfall prediction system using K-Means clustering and Naive Bayes based on historical rainfall data in Padang City.",
    tools: ["HTML", "CSS", "PHP", "MySQL", "Bootstrap"],
    dad: "300",
  },
  {
    ...
    desk: "A company profile website developed as a final project for a Web Programmer training program.",
    tools: [
      "HTML",
      "CSS",
      "PHP",
  ...
  },
  {
    ...
    desk: "A Laravel-based student and course management system with exam scoring, assignment uploads, admin authentication, and student performance reporting features.",
